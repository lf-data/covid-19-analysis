...
#' 
#' To improve my model first of all I transform the fatality rate and the infection rate using the logarithmic function. Then I remove the biggest influential point computed by Cook's distance. 
#' 
## ----fig.height=5.5, fig.width=6, fig.align='center'-------------------------
